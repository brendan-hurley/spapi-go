...
func (o *ListingsItemSubmissionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varListingsItemSubmissionResponse)
	...
	*o = ListingsItemSubmissionResponse(varListingsItemSubmissionResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "submissionId")
