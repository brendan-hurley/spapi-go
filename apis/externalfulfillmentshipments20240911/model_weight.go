...
func NewWeight(value string, weightUnit string) *Weight {
	this := Weight{}
	this.Value = value
...
func (o *Weight) GetWeightUnit() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Weight) GetWeightUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Weight) SetWeightUnit(v string) {
	o.WeightUnit = v
}
