...
type ShipmentDetails struct {
	...
	ShippedDate flextime.FlexTime `json:"shippedDate"`
	// The shipment status.
...
func NewShipmentDetails(shippedDate time.Time, shipmentStatus string) *ShipmentDetails {
	...
	this.ShippedDate = flextime.FlexTime{Time: shippedDate}
...
func (o *ShipmentDetails) GetShippedDateOk() (*flextime.FlexTime, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ShipmentDetails) SetShippedDate(v time.Time) {
	o.ShippedDate = flextime.FlexTime{Time: v}
}
...
// and a boolean to check if the value has been set.
func (o *ShipmentDetails) GetEstimatedDeliveryDateOk() (*flextime.FlexTime, bool) {
	if o == nil || IsNil(o.EstimatedDeliveryDate) {
		return nil, false
	}
