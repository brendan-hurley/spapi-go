...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
	...
	@param purchaseOrderNumber The purchase order number for which you want to return the shipping labels. It should be the same number as the `purchaseOrderNumber` in the order.
	@return ApiCreateShippingLabelsRequest
	*/
	CreateShippingLabels(ctx context.Context, purchaseOrderNumber string) ApiCreateShippingLabelsRequest

	// CreateShippingLabelsExecute executes the request
	//  @return ShippingLabel
	CreateShippingLabelsExecute(r ApiCreateShippingLabelsRequest) (*ShippingLabel, *http.Response, error)
...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param purchaseOrderNumber The purchase order number for which you want to return the shipping label. It should be the same `purchaseOrderNumber` that you received in the order.
	...
	*/
	...
	//  @return ShippingLabel
	GetShippingLabelExecute(r ApiGetShippingLabelRequest) (*ShippingLabel, *http.Response, error)
...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
	...
	*/
	...
	GetShippingLabelsExecute(r ApiGetShippingLabelsRequest) (*ShippingLabelList, *http.Response, error)
...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
	...
	*/
	...
	SubmitShippingLabelRequestExecute(r ApiSubmitShippingLabelRequestRequest) (*TransactionReference, *http.Response, error)
}

// VendorShippingLabelsAPIService VendorShippingLabelsAPI service
type VendorShippingLabelsAPIService service

type ApiCreateShippingLabelsRequest struct {
	ctx context.Context
...
func (r ApiCreateShippingLabelsRequest) Body(body CreateShippingLabelsRequest) ApiCreateShippingLabelsRequest {
	r.body = &body
	return r
}

func (r ApiCreateShippingLabelsRequest) Execute() (*ShippingLabel, *http.Response, error) {
	return r.ApiService.CreateShippingLabelsExecute(r)
}
...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
 ...
 @return ApiCreateShippingLabelsRequest
*/
func (a *VendorShippingLabelsAPIService) CreateShippingLabels(ctx context.Context, purchaseOrderNumber string) ApiCreateShippingLabelsRequest {
	return ApiCreateShippingLabelsRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return ShippingLabel
func (a *VendorShippingLabelsAPIService) CreateShippingLabelsExecute(r ApiCreateShippingLabelsRequest) (*ShippingLabel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VendorShippingLabelsAPIService.CreateShippingLabels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/vendor/directFulfillment/shipping/2021-12-28/shippingLabels/{purchaseOrderNumber}"
...
func (r ApiGetShippingLabelRequest) Execute() (*ShippingLabel, *http.Response, error) {
...
// Execute executes the request
//  @return ShippingLabel
func (a *VendorShippingLabelsAPIService) GetShippingLabelExecute(r ApiGetShippingLabelRequest) (*ShippingLabel, *http.Response, error) {
	var (
...
func (r ApiGetShippingLabelsRequest) Execute() (*ShippingLabelList, *http.Response, error) {
...
// Execute executes the request
//  @return ShippingLabelList
func (a *VendorShippingLabelsAPIService) GetShippingLabelsExecute(r ApiGetShippingLabelsRequest) (*ShippingLabelList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/vendor/directFulfillment/shipping/2021-12-28/shippingLabels"
...
func (r ApiSubmitShippingLabelRequestRequest) Execute() (*TransactionReference, *http.Response, error) {
...
// Execute executes the request
//  @return TransactionReference
func (a *VendorShippingLabelsAPIService) SubmitShippingLabelRequestExecute(r ApiSubmitShippingLabelRequestRequest) (*TransactionReference, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
