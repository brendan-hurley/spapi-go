...
func (o PostContentDocumentRequest) MarshalJSON() ([]byte, error) {
...
func (o *PostContentDocumentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostContentDocumentRequest := _PostContentDocumentRequest{}

	err = json.Unmarshal(data, &varPostContentDocumentRequest)

	if err != nil {
		return err
	}

	*o = PostContentDocumentRequest(varPostContentDocumentRequest)
