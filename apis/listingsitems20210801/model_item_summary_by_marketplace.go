...
func NewItemSummaryByMarketplace(marketplaceId string, productType string, status []string, createdDate time.Time, lastUpdatedDate time.Time) *ItemSummaryByMarketplace {
...
func (o *ItemSummaryByMarketplace) HasAsin() bool {
	if o != nil && !IsNil(o.Asin) {
		return true
	}
