...
func (o *FulfillmentAvailability) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFulfillmentAvailability)
	...
	*o = FulfillmentAvailability(varFulfillmentAvailability)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "fulfillmentChannelCode")
