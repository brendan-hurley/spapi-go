...
func NewAddress(name string, addressLine1 string, stateOrRegion string, countryCode string) *Address {
	this := Address{}
	this.Name = name
...
func (o *Address) GetAttention() string {
...
// and a boolean to check if the value has been set.
func (o *Address) GetAttentionOk() (*string, bool) {
	if o == nil || IsNil(o.Attention) {
		return nil, false
	}
...
func (o *Address) HasAttention() bool {
	if o != nil && !IsNil(o.Attention) {
		return true
	}
...
func (o *Address) SetAttention(v string) {
	o.Attention = &v
}
