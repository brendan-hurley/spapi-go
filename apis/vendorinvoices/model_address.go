...
func NewAddress(name string, addressLine1 string, countryCode string) *Address {
	this := Address{}
	this.Name = name
...
func (o *Address) GetPostalOrZipCode() string {
...
// and a boolean to check if the value has been set.
func (o *Address) GetPostalOrZipCodeOk() (*string, bool) {
	if o == nil || IsNil(o.PostalOrZipCode) {
		return nil, false
	}
...
func (o *Address) HasPostalOrZipCode() bool {
	if o != nil && !IsNil(o.PostalOrZipCode) {
		return true
	}
...
func (o *Address) SetPostalOrZipCode(v string) {
	o.PostalOrZipCode = &v
}
...
func (o Address) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PostalOrZipCode) {
		toSerialize["postalOrZipCode"] = o.PostalOrZipCode
	}
...
func (o *Address) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Address(varAddress)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "postalOrZipCode")
