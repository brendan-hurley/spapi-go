...
type _GetOrderItemsBuyerInfoResponse GetOrderItemsBuyerInfoResponse
...
func (o GetOrderItemsBuyerInfoResponse) MarshalJSON() ([]byte, error) {
...
func (o *GetOrderItemsBuyerInfoResponse) UnmarshalJSON(data []byte) (err error) {
	varGetOrderItemsBuyerInfoResponse := _GetOrderItemsBuyerInfoResponse{}

	err = json.Unmarshal(data, &varGetOrderItemsBuyerInfoResponse)

	if err != nil {
		return err
	}

	*o = GetOrderItemsBuyerInfoResponse(varGetOrderItemsBuyerInfoResponse)
