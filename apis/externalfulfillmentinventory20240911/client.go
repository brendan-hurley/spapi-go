...
// APIClient manages communication with the The Selling Partner API for External Fulfillment Inventory Management API v2024-09-11
...
type APIClient struct {
	...
	BatchInventoryAPI BatchInventoryAPI
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BatchInventoryAPI = (*BatchInventoryAPIService)(&c.common)
