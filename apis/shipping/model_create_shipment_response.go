...
type _CreateShipmentResponse CreateShipmentResponse
...
func (o *CreateShipmentResponse) GetPayload() CreateShipmentResult {
	if o == nil || IsNil(o.Payload) {
		var ret CreateShipmentResult
		return ret
	}
	return *o.Payload
}
...
func (o *CreateShipmentResponse) GetPayloadOk() (*CreateShipmentResult, bool) {
	if o == nil || IsNil(o.Payload) {
		return nil, false
	}
...
// SetPayload gets a reference to the given CreateShipmentResult and assigns it to the Payload field.
func (o *CreateShipmentResponse) SetPayload(v CreateShipmentResult) {
	o.Payload = &v
}
...
func (o CreateShipmentResponse) MarshalJSON() ([]byte, error) {
...
func (o *CreateShipmentResponse) UnmarshalJSON(data []byte) (err error) {
	varCreateShipmentResponse := _CreateShipmentResponse{}

	err = json.Unmarshal(data, &varCreateShipmentResponse)

	if err != nil {
		return err
	}

	*o = CreateShipmentResponse(varCreateShipmentResponse)
