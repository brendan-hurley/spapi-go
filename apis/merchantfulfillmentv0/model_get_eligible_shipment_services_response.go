...
type _GetEligibleShipmentServicesResponse GetEligibleShipmentServicesResponse
...
func (o GetEligibleShipmentServicesResponse) MarshalJSON() ([]byte, error) {
...
func (o *GetEligibleShipmentServicesResponse) UnmarshalJSON(data []byte) (err error) {
	varGetEligibleShipmentServicesResponse := _GetEligibleShipmentServicesResponse{}

	err = json.Unmarshal(data, &varGetEligibleShipmentServicesResponse)

	if err != nil {
		return err
	}

	*o = GetEligibleShipmentServicesResponse(varGetEligibleShipmentServicesResponse)
