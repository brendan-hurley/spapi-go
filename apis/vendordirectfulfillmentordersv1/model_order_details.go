...
func (o *OrderDetails) GetTaxTotal() OrderDetailsTaxTotal {
	if o == nil || IsNil(o.TaxTotal) {
		var ret OrderDetailsTaxTotal
		return ret
	}
	return *o.TaxTotal
}
...
// and a boolean to check if the value has been set.
func (o *OrderDetails) GetTaxTotalOk() (*OrderDetailsTaxTotal, bool) {
	if o == nil || IsNil(o.TaxTotal) {
		return nil, false
	}
...
// SetTaxTotal gets a reference to the given OrderDetailsTaxTotal and assigns it to the TaxTotal field.
func (o *OrderDetails) SetTaxTotal(v OrderDetailsTaxTotal) {
	o.TaxTotal = &v
}
