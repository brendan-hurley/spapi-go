...
//  @return GetOrderResponse
func (a *VendorOrdersAPIService) GetOrderExecute(r ApiGetOrderRequest) (*GetOrderResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/vendor/directFulfillment/orders/v1/purchaseOrders/{purchaseOrderNumber}"
...
// Execute executes the request
//  @return GetOrdersResponse
func (a *VendorOrdersAPIService) GetOrdersExecute(r ApiGetOrdersRequest) (*GetOrdersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/vendor/directFulfillment/orders/v1/purchaseOrders"
...
func (a *VendorOrdersAPIService) SubmitAcknowledgementExecute(r ApiSubmitAcknowledgementRequest) (*SubmitAcknowledgementResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/vendor/directFulfillment/orders/v1/acknowledgements"
