...
type _RestrictedResource RestrictedResource
...
func (o *RestrictedResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRestrictedResource := _RestrictedResource{}

	err = json.Unmarshal(data, &varRestrictedResource)

	if err != nil {
		return err
	}

	*o = RestrictedResource(varRestrictedResource)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dataElements")
