...
type _CreateRestrictedDataTokenResponse CreateRestrictedDataTokenResponse
...
func (o *CreateRestrictedDataTokenResponse) UnmarshalJSON(data []byte) (err error) {
	varCreateRestrictedDataTokenResponse := _CreateRestrictedDataTokenResponse{}

	err = json.Unmarshal(data, &varCreateRestrictedDataTokenResponse)

	if err != nil {
		return err
	}

	*o = CreateRestrictedDataTokenResponse(varCreateRestrictedDataTokenResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "restrictedDataToken")
