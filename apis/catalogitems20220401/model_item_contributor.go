...
func (o ItemContributor) MarshalJSON() ([]byte, error) {
...
func (o *ItemContributor) UnmarshalJSON(data []byte) (err error) {
	...
	varItemContributor := _ItemContributor{}

	err = json.Unmarshal(data, &varItemContributor)

	if err != nil {
		return err
	}

	*o = ItemContributor(varItemContributor)
