...
// GetRefinements returns the Refinements field value if set, zero value otherwise.
func (o *ItemSearchResults) GetRefinements() Refinements {
	if o == nil || IsNil(o.Refinements) {
		var ret Refinements
		return ret
	}
...
// GetRefinementsOk returns a tuple with the Refinements field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasRefinements returns a boolean if a field has been set.
func (o *ItemSearchResults) HasRefinements() bool {
	if o != nil && !IsNil(o.Refinements) {
		return true
	}
...
// SetRefinements gets a reference to the given Refinements and assigns it to the Refinements field.
