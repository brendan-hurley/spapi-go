...
type _CreateConfirmServiceDetailsResponse CreateConfirmServiceDetailsResponse
...
func (o CreateConfirmServiceDetailsResponse) MarshalJSON() ([]byte, error) {
...
func (o *CreateConfirmServiceDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	varCreateConfirmServiceDetailsResponse := _CreateConfirmServiceDetailsResponse{}

	err = json.Unmarshal(data, &varCreateConfirmServiceDetailsResponse)

	if err != nil {
		return err
	}

	*o = CreateConfirmServiceDetailsResponse(varCreateConfirmServiceDetailsResponse)
