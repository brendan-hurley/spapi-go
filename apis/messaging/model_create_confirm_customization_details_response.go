...
type _CreateConfirmCustomizationDetailsResponse CreateConfirmCustomizationDetailsResponse
...
func (o CreateConfirmCustomizationDetailsResponse) MarshalJSON() ([]byte, error) {
...
func (o *CreateConfirmCustomizationDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	varCreateConfirmCustomizationDetailsResponse := _CreateConfirmCustomizationDetailsResponse{}

	err = json.Unmarshal(data, &varCreateConfirmCustomizationDetailsResponse)

	if err != nil {
		return err
	}

	*o = CreateConfirmCustomizationDetailsResponse(varCreateConfirmCustomizationDetailsResponse)
