...
func NewSubmitInvoiceRequest(invoiceContent string, marketplaceId string, contentMD5Value string, invoiceType InvoiceType, programType ProgramType) *SubmitInvoiceRequest {
...
func (o *SubmitInvoiceRequest) GetInvoiceType() InvoiceType {
	if o == nil {
		var ret InvoiceType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SubmitInvoiceRequest) GetInvoiceTypeOk() (*InvoiceType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SubmitInvoiceRequest) SetInvoiceType(v InvoiceType) {
	o.InvoiceType = v
}

// GetProgramType returns the ProgramType field value
func (o *SubmitInvoiceRequest) GetProgramType() ProgramType {
	if o == nil {
		var ret ProgramType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SubmitInvoiceRequest) GetProgramTypeOk() (*ProgramType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SubmitInvoiceRequest) SetProgramType(v ProgramType) {
	o.ProgramType = v
}
