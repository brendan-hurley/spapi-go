...
func (o Incentive) MarshalJSON() ([]byte, error) {
...
func (o *Incentive) UnmarshalJSON(data []byte) (err error) {
	...
	varIncentive := _Incentive{}

	err = json.Unmarshal(data, &varIncentive)

	if err != nil {
		return err
	}

	*o = Incentive(varIncentive)
