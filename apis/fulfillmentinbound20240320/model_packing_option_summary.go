...
func (o PackingOptionSummary) MarshalJSON() ([]byte, error) {
...
func (o *PackingOptionSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varPackingOptionSummary := _PackingOptionSummary{}

	err = json.Unmarshal(data, &varPackingOptionSummary)

	if err != nil {
		return err
	}

	*o = PackingOptionSummary(varPackingOptionSummary)
