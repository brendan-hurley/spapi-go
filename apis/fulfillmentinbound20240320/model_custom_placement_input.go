...
func (o CustomPlacementInput) MarshalJSON() ([]byte, error) {
...
func (o *CustomPlacementInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomPlacementInput := _CustomPlacementInput{}

	err = json.Unmarshal(data, &varCustomPlacementInput)

	if err != nil {
		return err
	}

	*o = CustomPlacementInput(varCustomPlacementInput)
