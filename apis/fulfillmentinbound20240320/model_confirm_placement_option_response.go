...
func (o ConfirmPlacementOptionResponse) MarshalJSON() ([]byte, error) {
...
func (o *ConfirmPlacementOptionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varConfirmPlacementOptionResponse := _ConfirmPlacementOptionResponse{}

	err = json.Unmarshal(data, &varConfirmPlacementOptionResponse)

	if err != nil {
		return err
	}

	*o = ConfirmPlacementOptionResponse(varConfirmPlacementOptionResponse)
