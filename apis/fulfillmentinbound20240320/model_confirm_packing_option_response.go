...
func (o ConfirmPackingOptionResponse) MarshalJSON() ([]byte, error) {
...
func (o *ConfirmPackingOptionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varConfirmPackingOptionResponse := _ConfirmPackingOptionResponse{}

	err = json.Unmarshal(data, &varConfirmPackingOptionResponse)

	if err != nil {
		return err
	}

	*o = ConfirmPackingOptionResponse(varConfirmPackingOptionResponse)
