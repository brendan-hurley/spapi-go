...
func (o ListPackingGroupBoxesResponse) MarshalJSON() ([]byte, error) {
...
func (o *ListPackingGroupBoxesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListPackingGroupBoxesResponse := _ListPackingGroupBoxesResponse{}

	err = json.Unmarshal(data, &varListPackingGroupBoxesResponse)

	if err != nil {
		return err
	}

	*o = ListPackingGroupBoxesResponse(varListPackingGroupBoxesResponse)
