...
type _CancelSelfShipAppointmentRequest CancelSelfShipAppointmentRequest
...
func (o CancelSelfShipAppointmentRequest) MarshalJSON() ([]byte, error) {
...
func (o *CancelSelfShipAppointmentRequest) UnmarshalJSON(data []byte) (err error) {
	varCancelSelfShipAppointmentRequest := _CancelSelfShipAppointmentRequest{}

	err = json.Unmarshal(data, &varCancelSelfShipAppointmentRequest)

	if err != nil {
		return err
	}

	*o = CancelSelfShipAppointmentRequest(varCancelSelfShipAppointmentRequest)
