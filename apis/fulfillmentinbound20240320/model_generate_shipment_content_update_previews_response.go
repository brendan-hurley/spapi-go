...
func (o GenerateShipmentContentUpdatePreviewsResponse) MarshalJSON() ([]byte, error) {
...
func (o *GenerateShipmentContentUpdatePreviewsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGenerateShipmentContentUpdatePreviewsResponse := _GenerateShipmentContentUpdatePreviewsResponse{}

	err = json.Unmarshal(data, &varGenerateShipmentContentUpdatePreviewsResponse)

	if err != nil {
		return err
	}

	*o = GenerateShipmentContentUpdatePreviewsResponse(varGenerateShipmentContentUpdatePreviewsResponse)
