...
func (o ListShipmentItemsResponse) MarshalJSON() ([]byte, error) {
...
func (o *ListShipmentItemsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListShipmentItemsResponse := _ListShipmentItemsResponse{}

	err = json.Unmarshal(data, &varListShipmentItemsResponse)

	if err != nil {
		return err
	}

	*o = ListShipmentItemsResponse(varListShipmentItemsResponse)
