...
func (o UpdateShipmentSourceAddressResponse) MarshalJSON() ([]byte, error) {
...
func (o *UpdateShipmentSourceAddressResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateShipmentSourceAddressResponse := _UpdateShipmentSourceAddressResponse{}

	err = json.Unmarshal(data, &varUpdateShipmentSourceAddressResponse)

	if err != nil {
		return err
	}

	*o = UpdateShipmentSourceAddressResponse(varUpdateShipmentSourceAddressResponse)
