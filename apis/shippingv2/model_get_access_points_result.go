...
func (o GetAccessPointsResult) MarshalJSON() ([]byte, error) {
...
func (o *GetAccessPointsResult) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAccessPointsResult := _GetAccessPointsResult{}

	err = json.Unmarshal(data, &varGetAccessPointsResult)

	if err != nil {
		return err
	}

	*o = GetAccessPointsResult(varGetAccessPointsResult)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "accessPointsMap")
