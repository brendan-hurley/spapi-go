...
func (o IneligibilityReason) MarshalJSON() ([]byte, error) {
...
func (o *IneligibilityReason) UnmarshalJSON(data []byte) (err error) {
	...
	varIneligibilityReason := _IneligibilityReason{}

	err = json.Unmarshal(data, &varIneligibilityReason)

	if err != nil {
		return err
	}

	*o = IneligibilityReason(varIneligibilityReason)
