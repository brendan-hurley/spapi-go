...
func (o Geocode) MarshalJSON() ([]byte, error) {
...
func (o *Geocode) UnmarshalJSON(data []byte) (err error) {
	varGeocode := _Geocode{}

	err = json.Unmarshal(data, &varGeocode)

	if err != nil {
		return err
	}

	*o = Geocode(varGeocode)
