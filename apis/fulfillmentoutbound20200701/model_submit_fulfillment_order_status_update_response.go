...
type _SubmitFulfillmentOrderStatusUpdateResponse SubmitFulfillmentOrderStatusUpdateResponse
...
func (o SubmitFulfillmentOrderStatusUpdateResponse) MarshalJSON() ([]byte, error) {
...
func (o *SubmitFulfillmentOrderStatusUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	varSubmitFulfillmentOrderStatusUpdateResponse := _SubmitFulfillmentOrderStatusUpdateResponse{}

	err = json.Unmarshal(data, &varSubmitFulfillmentOrderStatusUpdateResponse)

	if err != nil {
		return err
	}

	*o = SubmitFulfillmentOrderStatusUpdateResponse(varSubmitFulfillmentOrderStatusUpdateResponse)
