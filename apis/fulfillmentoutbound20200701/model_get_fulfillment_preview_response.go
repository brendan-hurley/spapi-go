...
type _GetFulfillmentPreviewResponse GetFulfillmentPreviewResponse
...
func (o GetFulfillmentPreviewResponse) MarshalJSON() ([]byte, error) {
...
func (o *GetFulfillmentPreviewResponse) UnmarshalJSON(data []byte) (err error) {
	varGetFulfillmentPreviewResponse := _GetFulfillmentPreviewResponse{}

	err = json.Unmarshal(data, &varGetFulfillmentPreviewResponse)

	if err != nil {
		return err
	}

	*o = GetFulfillmentPreviewResponse(varGetFulfillmentPreviewResponse)
