...
func (o *PartyIdentification) GetTaxRegistrationDetails() []TaxRegistrationDetail {
	if o == nil || IsNil(o.TaxRegistrationDetails) {
		var ret []TaxRegistrationDetail
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PartyIdentification) GetTaxRegistrationDetailsOk() ([]TaxRegistrationDetail, bool) {
	if o == nil || IsNil(o.TaxRegistrationDetails) {
		return nil, false
	}
...
// SetTaxRegistrationDetails gets a reference to the given []TaxRegistrationDetail and assigns it to the TaxRegistrationDetails field.
func (o *PartyIdentification) SetTaxRegistrationDetails(v []TaxRegistrationDetail) {
