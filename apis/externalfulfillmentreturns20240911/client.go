...
// APIClient manages communication with the The Selling Partner API for Amazon External Fulfillment Return Item Processing API v2024-09-11
...
type APIClient struct {
	...
	ReturnRetrievalAPI ReturnRetrievalAPI
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ReturnRetrievalAPI = (*ReturnRetrievalAPIService)(&c.common)
