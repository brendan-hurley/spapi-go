...
type _SubmitShipmentConfirmationsResponse SubmitShipmentConfirmationsResponse
...
func (o SubmitShipmentConfirmationsResponse) MarshalJSON() ([]byte, error) {
...
func (o *SubmitShipmentConfirmationsResponse) UnmarshalJSON(data []byte) (err error) {
	varSubmitShipmentConfirmationsResponse := _SubmitShipmentConfirmationsResponse{}

	err = json.Unmarshal(data, &varSubmitShipmentConfirmationsResponse)

	if err != nil {
		return err
	}

	*o = SubmitShipmentConfirmationsResponse(varSubmitShipmentConfirmationsResponse)
