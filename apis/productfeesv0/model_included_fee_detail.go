...
func (o IncludedFeeDetail) MarshalJSON() ([]byte, error) {
...
func (o *IncludedFeeDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludedFeeDetail := _IncludedFeeDetail{}

	err = json.Unmarshal(data, &varIncludedFeeDetail)

	if err != nil {
		return err
	}

	*o = IncludedFeeDetail(varIncludedFeeDetail)
